...
/// Algorithm-neutral prediction metrics. Scheduler implementations return this
/// shape so future scheduler majors can be compared against the same immutable
/// review history without changing the history contract.

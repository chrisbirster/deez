...
pub const Parameters = struct {
    ...
    pub fn validate(self: Parameters) !void {
        ...
        const ranges = [_][2]f64{
            ...
            .{ 1.0, 10.0 }, .{ 0.001, 4.0 }, .{ 0.1, 4.0 },
            .{ 0.0, 4.0 }, .{ 0.0, 1.2 }, .{ 0.3, 3.0 }, .{ 0.01, 1.5 }, .{ 0.001, 0.9 }, .{ 0.1, 1.0 }, .{ 0.0, 3.5 }, .{ 0.0, 1.0 }, .{ 1.0, 7.0 },
            .{ 0.0, 4.0 }, .{ 0.0, 2.0 }, .{ 0.5, 6.0 }, .{ 0.001, 1.5 }, .{ 0.001, 2.0 }, .{ 0.001, 1.0 }, .{ 0.0, 5.0 }, .{ 0.0, 1.0 }, .{ 1.0, 7.0 },
            .{ 2.5, 15.0 }, .{ 0.0, 1.0 },
            .{ 0.01, 0.25 }, .{ 0.01, 0.95 }, .{ 0.5, 0.85 }, .{ 0.5, 0.99 }, .{ 0.01, 1.0 }, .{ 0.1, 1.0 }, .{ 0.0, 0.9 }, .{ 0.1, 1.1 },
        };
